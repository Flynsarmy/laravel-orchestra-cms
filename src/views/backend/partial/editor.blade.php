	...
	<fieldset>
		<div class="row editor-buttons">
			...
			<div class="six columns text-right">
				<a href="{{ resources("orchestra-cms.partials") }}" class="btn btn-danger">
					<span class='glyphicon glyphicon-remove'></span>
					Cancel
				</a>
				@if ($content->exists)
					<a href="{{ resources("orchestra-cms.partials/{$content->id}/delete") }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this partial?');">
