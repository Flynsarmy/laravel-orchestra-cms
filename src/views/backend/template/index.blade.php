...
if ($acl->can("create template") or $acl->can("manage template")) :
		...
		<table class="table table-striped">
			...
			@foreach ($contents as $content)
				...
				<tr>
					<td>
						<strong>
							@if ($acl->can("manage template") or ($owner and $acl->can("update template")))
								<a href="{{ resources("orchestra-cms.templates/{$content->id}/edit") }}">
									{{{ $content->title }}}
								</a>
							@else
								{{{ $content->title }}}
					...
					<td>
						<div class="btn-group">
							@if ($acl->can("manage template") or ($owner and $acl->can("delete template")))
								<a href="{{ resources("orchestra-cms.templates/{$content->id}/delete") }}" class="btn btn-mini btn-danger" onclick="return confirm('Are you sure you want to delete this template?');">
									Delete
								</a>
							@endif
						</div>
